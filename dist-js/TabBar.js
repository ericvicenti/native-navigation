...
var NativeTabBar=_reactNativeSafeModule2.default.component({
...
TabBar=function(_React$Component){_inherits(TabBar,_React$Component);function TabBar(){_classCallCheck(this,TabBar);return _possibleConstructorReturn(this,(TabBar.__proto__||Object.getPrototypeOf(TabBar)).apply(this,arguments));}_createClass(TabBar,[{key:'render',value:function render()
{var _props=
this.props,children=_props.children,config=_objectWithoutProperties(_props,['children']);

return(
_react2.default.createElement(NativeTabBar,{
